...
@section('title')
<title>អ្នកប្រើប្រាស់ថ្មី</title>
@stop
...
<!-- RIBBON -->
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>អ្នកប្រើប្រាស់</li><li>អ្នកប្រើប្រាស់ថ្មី</li>
		</ol>
		<!-- end breadcrumb -->
		       ...
		       <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">        
		        ...
		        <div>
		         ...
		         <div class="widget-body no-padding">
		             {!! Form::open(['route' => 'user.store', 'files' => true , 'novalidate' => 'validate', 'id' => 'checkout-form', 'class'=>'smart-form']) !!}                   
		           ...
		           <fieldset>
		            ...
		            <fieldset>
			            ...
			            <div class="row">
			             ...
			             <section class="col col-6">
			              {{ Form::label('u_password', 'លេខសម្ងាត់', array('class' => 'label')) }}
			              <label class="input"> <i class="icon-append fa fa-lock"></i>
			               {!! Form::text("u_password", $value = null, $attributes = array('class' => 'form-control', 'id' => 'u_password', 'placeholder'=>'Password')) !!}
			              </label>
			             </section>
			            </div>
