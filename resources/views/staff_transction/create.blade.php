...
@section('title')
<title>{{trans('label.new_transaction')}}</title>
@stop
...
<!-- RIBBON -->
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>{{trans('label.staff_transaction')}}</li><li>{{trans('label.new_transaction')}}</li>
		</ol>
		<!-- end breadcrumb -->
		      ...
		      <article class="col-sm-12 col-md-12 col-lg-12">
		       ...
		       <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">        
		        <header>
		         ...
		         <h2>{{trans('label.add_transaction')}}</h2>    
		        ...
		        <div>
		         ...
		         <div class="widget-body no-padding">
		             {!! Form::open(['route' => 'stafftransction.store', 'files' => true , 'novalidate' => 'validate', 'id' => 'checkout-form', 'class'=>'smart-form']) !!}                   
			            ...
			            <div class="row">
				             ...
				             <section class="col col-4">
				              ...
				              <label class="input"> <i class="icon-append fa fa-mobile"></i>
				               {!! Form::text("st_price", $value = null, $attributes = array( 'id' => 'st_price', 'class'=>'form-control num')) !!}
				              </label>
				             </section>
