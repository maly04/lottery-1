...
@section('title')
<title>{{trans('label.add_pos_group')}}</title>
@stop
...
<!-- RIBBON -->
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>{{trans('label.group')}}</li><li>{{trans('label.add_pos_group')}}</li>
		</ol>
		<!-- end breadcrumb -->
		      ...
		      <article class="col-sm-12 col-md-12 col-lg-12">
		       ...
		       <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">        
		        <header>
		         ...
		         <h2>{{trans('label.add_pos_group')}}</h2>    
		        ...
		        <div>
		         ...
		         <div class="widget-body no-padding">
		             {!! Form::open(['route' => 'posgroup.store', 'files' => true , 'novalidate' => 'validate', 'id' => 'checkout-form', 'class'=>'smart-form']) !!}                   
			            ...
			            <div class="row">
				             <section class="col col-6">
				              ...
				              <label class="select"><i class="icon-append fa"></i>
				               		{!! Form::select('g_id', (['' => 'Choose']+$listGroup) , null,['class' => 'select2 ','id'=>'g_id']) !!}
				              </label>
				             </section>
				             <section class="col col-6">
					              {{ Form::label('pos_time', trans('label.time'), array('class' => 'label')) }}
					              <label class="select"> <i class="icon-append fa"></i>
				              		{{ Form::select('pos_time',(['' =>$times]) , null, ['class' => 'select2 request-pos','id'=>'pos_time']) }}
				              	  </label>
				             </section>
				        </div>
										...
										@if($q%3 != 0)
											<div class="col col-4">
												<label class="checkbox">
													<input type="checkbox" name="pos_id[]" value="{{$keyPos}}">
													<i></i>{{$listPos}}</label>
											</div>
										@else
											<div class="col col-4">
