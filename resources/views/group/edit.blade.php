...
@section('title')
<title>{{trans('label.edit_group')}}</title>
@stop
...
<!-- RIBBON -->
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>{{trans('label.group')}}</li><li>{{trans('label.edit_group')}}</li>
		</ol>
		<!-- end breadcrumb -->
		       ...
		       <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">        
		        ...
		        <div>
		         ...
		         <div class="widget-body no-padding">
		            ...
		            {!! Form::model($group, ['route' => ['group.update', $group->g_id] ,'method' => 'PATCH',  'class' => 'smart-form user-form', 'novalidate' => 'validate', 'id' => 'checkout-form' ,"autocomplete"=>"false"]) !!}                   
