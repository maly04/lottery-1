...
@section('content')
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>{{ trans('result.result') }}</li><li>{{ trans('result.update') }}</li>
        </ol>
        <!-- end breadcrumb -->
                ...
                <article class="col-sm-12 col-md-12 col-lg-12 bee">
                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">
                        <header>
                            ...
                            <h2>{{ trans('result.resultModify') }}</h2>
                        ...
                        <div>
                            ...
                            <article class="widget-body no-padding">
                                {!! Form::open(['route' => 'filterUpdate', 'files' => true , 'novalidate' => 'validate', 'id' => 'filter','class'=>'smart-form filter-form']) !!}
                                <fieldset>
                                    @if(isset($var_date))
                                                ...
                                                <article class="col-sm-2 col-md-2 col-lg-2">
                                                    ...
                                                    <article class="col-sm-2 col-md-2 col-lg-2">
                                                        ...
                                                        @foreach($pos[2] as $val)
                                                            <?php $x++;?>
                                                        <section class="col">
                                                            {!! Form::text("two_digit[]", $value = $val, $attributes = array('id'=>'val2digit'.$i.'_'.$x,'class' => 'form-control required num twodigit', 'placeholder'=>trans('label.priceFor2Digits') ,'sms'=> trans('result.price2digits'), 'number'=>'true')) !!}
                                                            {!! Form::hidden("post_id2[]", $value = $pos[0], $attributes = array('class' => 'form-control')) !!}
                                                        </section>
                                                        @endforeach
                                                    </article>
                                                    {{--3digit--}}
                                                    <article class="col-sm-3 col-md-3 col-lg-3">
                                                        ...
                                                        <section class="col">
                                                            {!! Form::text("three_digit[]", $value = $val, $attributes = array('id'=>'val3digit'.$i.'_'.$x,'class' => 'form-control required num threedigit', 'placeholder'=>trans('label.priceFor3Digits') ,'sms'=> trans('result.price3digits'), 'number'=>'true')) !!}
                                                            {!! Form::hidden("post_id3[]", $value = $pos[0], $attributes = array('class' => 'form-control')) !!}
                                                        </section>
                                                        @endforeach
                                                    </article>
                                            </div>
