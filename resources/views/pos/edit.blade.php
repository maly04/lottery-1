...
@section('title')
<title>{{trans('label.edit_pos')}}</title>
@stop
...
<!-- RIBBON -->
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>{{trans('label.pos')}}</li><li>{{trans('label.edit_pos')}}</li>
		</ol>
		<!-- end breadcrumb -->
		       ...
		       <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">        
		        ...
		        <div>
		         ...
		         <div class="widget-body no-padding">
		             ...
		             {!! Form::model($pos, ['route' => ['pos.update', $pos->pos_id] ,'method' => 'PATCH',  'class' => 'smart-form user-form', 'novalidate' => 'validate', 'id' => 'checkout-form' ,"autocomplete"=>"false"]) !!}                   
